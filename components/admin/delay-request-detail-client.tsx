      ...
      <PageHeader
        ...
        actions={
          delay.status === DelayRequestStatus.PENDING ? (
            ...
            <Badge variant={STATUS_VARIANT[delay.status]}>
        ...
        <Card>
          ...
          <CardContent className="flex flex-col gap-3 text-sm">
            <div className="flex flex-col gap-1">
              ...
              <Link
                href={`/admin/organizations/${delay.orderItem.order.organization.id}`}
            ...
            <div className="flex flex-col gap-1">
              ...
              <Link
                href={`/admin/orders/${delay.orderItem.order.id}`}
                className="font-medium hover:underline"
              >
            ...
            <div className="flex flex-col gap-1">
              ...
              <Link
                href={`/admin/measures/${delay.orderItem.measure.id}/edit`}
                className="font-medium hover:underline"
              >
